...
class AllBankView extends StatefulWidget {
  const AllBankView({super.key});

  @override
  State<AllBankView> createState() => _AllBankViewState();
}

class _AllBankViewState extends State<AllBankView> {
